        ...
        <>
            <div className={style.background}>
                            ...
                            <Dialog.Content className={style.modal_content}>
                                ...
                                <div className={style.modal_body}>
                                    <div className={style.modal_contact_item}>
                                        <span>Имя:</span> <strong>Dubai Helper Properties</strong>
                                    </div>
                                    <div className={style.contactItem}>
                                        <span>Телефон:</span>{" "}
                                        <a href="tel:+971542236053" className={style.phone_link}>
                                            +971 54 223-6053
                                        </a>
                                    </div>
                ...
                <div className={style.info}>
                    <p>Адрес: Dubai Helper Properties</p>
                    <p>Business Bay Dubai UAE</p>
                    <p>
                        Телефон:{" "}
                        <a className={style.phone} href="tel:+971542236053">
                            +971 54 223-6053
                        </a>
                    </p>
                    <div className={style.iconssocnetwork}>
                        <a href={import.meta.env.VITE_TELEGRAM_LINK}>
                            <svg
                                width="48"
                                height="48"
